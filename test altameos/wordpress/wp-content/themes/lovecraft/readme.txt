...
-------------------------
- Fixed the "Number of posts" setting in the custom Recent Posts widget not working.
- Added the "Requires PHP" line to style.css and readme.txt.
- Removed .map files (and references to them in the corresponding minified assets) since they're no longer allowed on WordPress.org.
