jQuery(document).ready(function($) {
    'use strict';
    var this_obj = the_computer_repair_plugin_activate_plugin;
    ...
    $(document).on('click', '.the-computer-repair-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message the-computer-repair-plugin-install');
                button.addClass('button-primary the-computer-repair-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.the-computer-repair-recommended-plugins .the-computer-repair-activation-note').css('display','block');
    ...
    $(document).on('click', '.the-computer-repair-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .the-computer-repair-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .the-computer-repair-recommended-plugins').css('display','none');
    });
