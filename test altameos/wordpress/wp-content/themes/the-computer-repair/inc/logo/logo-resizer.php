...
function the_computer_repair_logo_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('the_computer_repair_logo_padding',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('the_computer_repair_logo_padding',array(
		'label'	=> __('Logo Padding','the-computer-repair'),
	...
	$wp_customize->add_setting('the_computer_repair_logo_margin',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('the_computer_repair_logo_margin',array(
		'label'	=> __('Logo Margin','the-computer-repair'),
		'description'	=> __('Enter a value in pixels. Example:20px','the-computer-repair'),
		'input_attrs' => array(
      'placeholder' => __( '10px', 'the-computer-repair' ),
    ),
  ...
  $wp_customize->add_setting('the_computer_repair_site_title_font_size',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('the_computer_repair_site_title_font_size',array(
		'label'	=> __('Site Title Font Size','the-computer-repair'),
		'description'	=> __('Enter a value in pixels. Example:20px','the-computer-repair'),
		'input_attrs' => array(
      'placeholder' => __( '10px', 'the-computer-repair' ),
    ),
		'section'=> 'title_tagline',
		'type'=> 'text',
		'active_callback' => 'the_computer_repair_logo_title_hide_show'
	));
  ...
  $wp_customize->add_setting('the_computer_repair_site_tagline_font_size',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('the_computer_repair_site_tagline_font_size',array(
		'label'	=> __('Site Tagline Font Size','the-computer-repair'),
		'description'	=> __('Enter a value in pixels. Example:20px','the-computer-repair'),
		'input_attrs' => array(
      'placeholder' => __( '10px', 'the-computer-repair' ),
    ),
    'priority'    => 12,
		'section'=> 'title_tagline',
		'type'=> 'text',
		'active_callback' => 'the_computer_repair_tagline_hide_show'
	));
}
