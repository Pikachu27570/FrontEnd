    ...
    <div class="tab-sec">
		...
		<div id="product_addons_editor" class="tabcontent">
			<?php if(!class_exists('IEPA_Loader')){
				$plugin_ins = The_Computer_Repair_Plugin_Activation_Woo_Products::get_instance();
				$the_computer_repair_actions = $plugin_ins->recommended_actions;
				?>
				<div class="the-computer-repair-recommended-plugins">
					    <div class="the-computer-repair-action-list">
			...
			<?php }else{ ?>
				...
				<div class="the-computer-repair-pattern-page">
					...
					<p><b><?php esc_html_e('2. Go To Dashboard >> Ibtana Settings >> Woocommerce Templates','the-computer-repair'); ?></span></b></p>
	              	<div class="the-computer-repair-pattern-page">
			    		<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-woocommerce-templates&ive_wizard_view=parent' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Woocommerce Templates','the-computer-repair'); ?></a>
			    	</div>
	              	<p><?php esc_html_e('You can create a template as you like.','the-computer-repair'); ?></span></p>
			    </div>
			<?php } ?>
		</div>
