...
if ( ! class_exists( 'The_Computer_Repair_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class The_Computer_Repair_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new The_Computer_Repair_WPTT_WebFont_Loader( $url );
