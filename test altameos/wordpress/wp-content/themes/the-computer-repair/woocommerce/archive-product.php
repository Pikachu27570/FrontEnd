...
<div class="container">
	<main id="maincontent" role="main" class="middle-align">
		<div class="row m-0">
			<?php if(get_theme_mod('the_computer_repair_shop_page_layout', 'Right Sidebar') == 'Right Sidebar'){ ?>
			...
			<?php if ( 'Disable' != $the_computer_repair_woocommerce_shop_page_sidebar ) {?>
				<div id="sidebar" class="col-lg-4 col-md-4">
					<?php dynamic_sidebar('woocommerce-shop-sidebar'); ?>
				</div>
			<?php }?>
			<?php } elseif(get_theme_mod('the_computer_repair_shop_page_layout', 'Right Sidebar') == 'Left Sidebar'){ ?>
			<?php if ( 'Disable' != $the_computer_repair_woocommerce_shop_page_sidebar ) {?>
				<div id="sidebar" class="col-lg-4 col-md-4">
					<?php dynamic_sidebar('woocommerce-shop-sidebar'); ?>
				</div>
