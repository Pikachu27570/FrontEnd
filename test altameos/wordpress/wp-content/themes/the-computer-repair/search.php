            ...
            if($the_computer_repair_theme_lay == 'Left Sidebar'){ ?>
                <div class="row m-0">
                    ...
                    <div id="our-services" class="services col-lg-8 col-md-8">
                        ...
                        printf( esc_html__( 'Results For: %s','the-computer-repair'), esc_html( get_search_query() ) ); ?></h1> 
                        <?php if ( have_posts() ) :
                            /* Start the Loop */
                        ...
                        ?>
                        <?php if( get_theme_mod( 'the_computer_repair_blog_pagination_hide_show',true) ==1) { ?>
                            <div class="navigation">
                                <?php the_computer_repair_blog_posts_pagination(); ?>
